...
<section class="mx-auto w-1/2 m-8 bg-zinc-200 text-sm text-zinc-800 p-4 rounded-lg shadow">
    <header class="-mx-4 bg-zinc-700 text-zinc-200 text-md text-semibold p-4 -mt-4 mb-4 rounded-t flex-0">
        <h4>Welcome to the Simple Jokes System!</h4>
    </header>
    <p>
        The Simple Jokes System is your go-to platform for sharing and managing jokes effortlessly!
        With a user-friendly interface, you can quickly register, log in, and start adding your favorite jokes.
        Edit or delete your jokes with ease, and enjoy optional category management to keep things organized.
        Join us today and let the laughter begin!
    </p>
</section>
